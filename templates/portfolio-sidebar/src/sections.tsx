...
/**
 * Reusable ProfileView section renderers shared by the About and Résumé pages.
 * Each returns `null` when its section is empty so callers drop them in
 * unconditionally. Same section semantics as `portfolio-minimal` — the visual
 * difference is the shell + stylesheet, not the data mapping.
 */
